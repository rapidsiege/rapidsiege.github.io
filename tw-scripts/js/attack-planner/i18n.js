...
const LANG = {
  en: {
    ...
    rp_hint: '🏠 = free village: not the sender of any other off / noble attack in this plan and not pinned as a sender by the Offensive Plan. Only villages whose send window is still open — right now or later — are listed; for an off, only villages with at least 300,000 off power.',
    ...
    scav_factor_looks_speed: 'this looks like a world speed — on a 2× world the factor is ≈0.683; clear the field for auto',
  ...
  es: {
    ...
    rp_hint: '🏠 = pueblo libre: no es origen de ningún otro ataque off / noble de este plan ni está fijado como origen en el Plan Ofensivo. Solo se listan pueblos cuya ventana de envío sigue abierta — ahora o más tarde; para una off, solo pueblos con al menos 300.000 de poder off.',
    ...
    scav_factor_looks_speed: 'parece una velocidad de mundo: en un mundo 2× el factor es ≈0,683; vacía el campo para automático',
