...
(function () {
  ...
  var PROTECTED_ALLIES = { "13": 1, "27": 1 };
  ...
  function loadProtCoords() {
    return Promise.all([
      fetch("../data/es100/player.txt").then(function (r) { return r.ok ? r.text() : ""; }),
      fetch("../data/es100/village.txt").then(function (r) { return r.ok ? r.text() : ""; }),
    ]).then(function (res) {
